        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NightAuditStartedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    NightAuditBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    ReopenedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prefix = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PaddingWidth = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanVoid = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CanRefund = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_BusinessDate",
                table: "AuditLogs",
                column: "BusinessDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessDates_Date",
                table: "BusinessDates",
                column: "Date",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DocumentNumberCounters_DocumentType_Year",
